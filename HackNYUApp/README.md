...
* HackNYU is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as HackNYU is mean to act as a starting point for Android Applications.

# HackNYU App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-hacknyu-brill-darrengeng.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-hacknyu-brill-darrengeng)

This repository contains the source code for the [HackNYU](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.hacknyu.brill.darrengeng).

Please see the [issues](https://github.com.hacknyu.brill.darrengeng/com-hacknyu-brill-darrengeng/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about HackNYU? Ask away on the [com-hacknyu-brill-darrengeng discussion forum](https://groups.google.com/forum/#!forum/com-hacknyu-brill-darrengeng).

<a href="https://play.google.com/store/apps/details?id=com.hacknyu.brill.darrengeng" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.hacknyu.brill.darrengeng__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.hacknyu.brill.darrengeng__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.hacknyu.brill.darrengeng.R__) will now be renamed
...
signed with a different key.  Manually uninstall HackNYU from your device and
...
HackNYU is a result of a template project I've developed over the years as well as
...
HackNYU is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.hacknyu.brill.darrengeng/com-hacknyu-brill-darrengeng/contributors) on
...
[pull requests](https://github.com.hacknyu.brill.darrengeng/com-hacknyu-brill-darrengeng/pulls).
